...
Folow this step: https://github.com/mohimenulislam/cka-note/blob/4f6f2781eac352a7fa8a5e39c44671af16c0f72a/CKA/2.%20Docker%20Installation.md
...
Next, use the modprobe command to add the module
```bash
modprobe overlay
...
#### Add worker node to hosts file
```bash
vi /etc/hosts
  192.168.10.102  worker3
```
...
#### Tocken Create from master node
```bash
kubeadm token create --print-join-command
# copy this output and run in worker node 
```
